...
#include "Abilities/Tasks/AbilityTask_NetworkSyncPoint.h" // for the enum
#include "AbilityTask_AxNetworkSyncPoint.generated.h"


DECLARE_DELEGATE(FAxNetworkSyncDelegate);

/**
 * 
 */
UCLASS()
class AXCOMMON_API UAbilityTask_AxNetworkSyncPoint : public UAbilityTask
{
	GENERATED_UCLASS_BODY()
	
	FAxNetworkSyncDelegate	OnSync;
	...
	static UAbilityTask_AxNetworkSyncPoint* AxWaitNetSync(UGameplayAbility* OwningAbility, EAbilityTaskNetSyncType SyncType);
